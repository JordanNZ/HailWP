<?php
/**
 * Template Name: Enrolment Gleniti
 *
 * @package WordPress
...
<div class="uk-background-cover uk-flex uk-flex-center uk-flex-middle uk-light" style="height: 300px; background-image: url('<?php echo do_shortcode('[hail_hero pid=' . $module1 .']'); ?>');">
...
<?php echo do_shortcode('[hail_title pid=' . $module1 .']'); ?></h1>
...
<div class="uk-margin uk-width-xlarge uk-margin-auto uk-text-center uk-scrollspy-inview uk-animation-fade" uk-scrollspy-class="" style="">
	<?php //echo do_shortcode('[hail_lead pid=' . $module1 .']'); ?>
</div>
...
<?php echo do_shortcode('[hail_title pid=' . $module2 .']'); ?></h3>


<?php echo do_shortcode('[hail_page pid=' . $module2 .']'); ?>
